...
function Inspector() {
  ...
  const resetPayload = () => { setPayload(''); setResult(null); setPdfName(''); setPdfStatus(''); setShareEmail(''); setShareError(''); };
...
function ResultPanel({ result, payload, shareEmail, setShareEmail, shareError, setShareError }: {
  result: any;
  payload: string;
  shareEmail: string;
